...
struct JournalTheme {
    ...
    var bg: Color { 
        ...
        return isDark ? Color(hex: 0x1F1E1D) : Color(hex: 0xFAF9F5) 
    }
    ...
    var bgAlt: Color { 
        ...
        return isDark ? Color(hex: 0x26251F) : Color(hex: 0xF5F4EE) 
    }
    ...
    var surface: Color { 
        ...
        return isDark ? Color(hex: 0x2A2928) : .white 
    }
    ...
    var surfaceRaised: Color { 
        ...
        return isDark ? Color(hex: 0x30302E) : .white 
    }
    ...
    var surfaceSunken: Color { 
        ...
        return isDark ? Color(hex: 0x161615) : Color(hex: 0xF0EEE6) 
    }
    ...
    var paperBg: Color { 
        ...
        return isDark ? Color(hex: 0x25211C) : Color(hex: 0xF5EFE0) 
    }
    ...
    var accentSoft: Color { 
        if isDark && useOLED {
            return Color(hex: 0x2A1F1A)
        }
        return isDark ? Color(hex: 0x3A2E27) : Color(hex: 0xF5E6DF) 
    }

    var border1: Color { 
        if isDark && useOLED {
            return Color(hex: 0x252525)
        }
        return isDark ? Color(hex: 0x3A3937) : Color(hex: 0xE8E5DA) 
    }
    ...
    var border2: Color { 
        ...
        return isDark ? Color(hex: 0x4A4845) : Color(hex: 0xD8D4C8) 
    }
    ...
    var scrim: Color { 
        ...
        return isDark ? .black.opacity(0.6) : Color(hex: 0x141413).opacity(0.44) 
    }

    var iconChipBg: Color {
        if isDark && useOLED {
            return Color(hex: 0x1A1A1A).opacity(0.85)
        }
        return isDark ? Color(hex: 0x322C26).opacity(0.7) : Color(hex: 0xFAF7F0).opacity(0.72)
    }
    
    var iconChipBorder: Color {
        if isDark && useOLED {
            return Color(hex: 0xF0E1BE).opacity(0.12)
        }
        return isDark ? Color(hex: 0xF0E1BE).opacity(0.10) : Color(hex: 0x8C6E3C).opacity(0.14)
    }
}
